...
def test_s3_generator():
    ...
    assert generator.get_oddrn_by_path("columns") == '//s3/cloud/aws/buckets/accounts/keys/developers.csv/columns/age'

def test_s3_generator_from_s3_url():
    generator = S3Generator.from_s3_url("s3://accounts/company/developers/middle.csv")
    assert generator.get_oddrn_by_path("keys") == "//s3/cloud/aws/buckets/accounts/keys/company:developers:middle.csv"
